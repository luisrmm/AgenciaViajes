<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAlquieresAnuales.aspx.cs" Inherits="ProyectoV2.frmAlquieresAnuales" %>
...
<body>
    ...
    <div class="FormRegistroProductos">
      ...
      <br />
      <br />
      <asp:Label ID="Label1" runat="server" ForeColor="White" Text="Reporte Anual"></asp:Label>
      <br />
      <br />
      <asp:TextBox ID="txtfacilidades" CssClass="controls" runat="server"></asp:TextBox>
       <br />
        <asp:Button ID="btnHuespedes" CssClass="BOTON"  runat="server"  Text="Consultar" OnClick="btnHuespedes_Click" Width="200px"/>
        <asp:GridView ID="dgvAlquilerAnno" runat="server" CellPadding="60" CellSpacing="2" ForeColor="#333333" GridLines="None" Height="10px" Width="600px">
